...
builder.Services.AddSwaggerGen(c =>
{
    ...
    c.AddSecurityDefinition("Bearer", new Microsoft.OpenApi.Models.OpenApiSecurityScheme
    {
        ...
        Description = "Enter your JWT token in 'Bearer' format"
    });
...
.AddJwtBearer(options =>
{
    ...
    options.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(config["Jwt:Key"] ?? throw new ArgumentNullException("Jwt:Key", "JWT secret key is missing in the configuration."))),
    };
});
